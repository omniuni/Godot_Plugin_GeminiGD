...
@onready var option_button_model: OptionButton = $MarginContainer/GridContainer/OptionButtonModel
@onready var option_button_thinking_level: OptionButton = $MarginContainer/GridContainer/OptionButtonThinkingLevel
@onready var spin_box_max_history: SpinBox = $MarginContainer/GridContainer/SpinBoxMaxHistory
@onready var spin_box_dynamic_context: SpinBox = $MarginContainer/GridContainer/SpinBoxDynamicContext
